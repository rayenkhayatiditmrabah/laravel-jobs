                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-10">
                                                <input class="form-control " type="text" placeholder="Nom"
                                                    id="example-text-input" required value="{{ $data->nom }}" name="nom">
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            <label for="example-search-input" class="col-md-2 col-form-label">Image</label>
                                            <div class="col-md-10">
                                                <input class="form-control" type="file" id="example-search-input" value="{{ $data->image }}" name="image">
                                            </div>
                                            <img src="/uploads/students/{{ $data->image }}" style="width: 15%">
                                        </div>
